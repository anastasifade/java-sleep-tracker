...
import ru.yandex.practicum.sleeptracker.analysis.FindMinDurationFunction;
...
public class FindMinDurationTest {
    private static FindMinDurationFunction function;
    ...
    @Test
    public void minDurationExpectedForMultiSessionLog() {
        data.addSleepSession(new SleepSession(LocalDateTime.now(),
                LocalDateTime.now().plus(minDuration),
                SleepQuality.GOOD));
        data.addSleepSession(new SleepSession(LocalDateTime.now(),
